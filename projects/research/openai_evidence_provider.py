...
class OpenAIEvidenceProvider:
    ...
    def _build_request(self, job_payload: dict[str, Any]) -> dict[str, Any]:
        ...
        instructions = (
            ...
            "the same item. Collect 2 to 5 non-duplicate items from at least "
            "2 independent domains. Include at least one official or academic "
            "item and either a counterpoint or explicit uncertainty. Do not turn speculation "
